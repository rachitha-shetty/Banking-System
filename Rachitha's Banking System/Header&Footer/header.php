...
<a class="navbar-brand" style="color: 	blue;">Rachitha's Banking System</a>
</div>
...
<li><a href = "index.php" style="color: light blue;"><span class = "glyphicon glyphicon-home"></span> Home</a></li>
</ul>
</div>
</div>
</nav>